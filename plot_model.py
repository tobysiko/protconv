...
clf = cs.CATH_Classifier(root_path, outdir=results_dir, img_dim=dim, nchannels=nchannels)
...
try:
    new_files =clf.visualize_cath_image_data(
            ...
            use_pixels=False, 
            use_pfp=True, 
            pfp_layername=["fc_last","final","global_average_pooling2d_1", 'img_conv_bottleneck',"dropout_2"],# list of potential layers to extract fingerprints from. pick first one in list that exists.
            ndims=2, 
