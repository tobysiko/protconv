...
for p in params:
    clf = cs.CATH_Classifier(
                    ...
                    generic_label="seq2img-physchem-clf%s"%(str(p).replace(".","")), h5_backend="h5py",
                    
                    use_img_encoder=False, use_img_decoder=True,
                    cath_loss_weight=p, dc_decoder_loss="mean_absolute_error",checkpoints=20,
